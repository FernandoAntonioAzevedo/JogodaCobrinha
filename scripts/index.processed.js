...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _consts2 = __webpack_require__(331);

	var _Box = __webpack_require__(339);

	var _Box2 = _interopRequireDefault(_Box);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var SNAKE_SOUND = new Audio('https://sndup.net/3bcm/ekans.mp3');
	var SOUNDTRACK = new Audio('https://sndup.net/2dd6/Pokemon.mp3');
	SOUNDTRACK.volume = 0.1;

	var canvas = document.getElementById('game-canvas');
	var gameContainer = document.getElementById('game');
	var gamesBtns = document.getElementById('games-btns');

	var gameSnakeBtn = document.getElementById('snake-game');
	var gameCrushBtn = document.getElementById('crush-game');
	...
	gameSnakeBtn.addEventListener('click', function () {
	  ...
	  var infoBox = new _Box2.default('info-box');
	  var errorBox = new _Box2.default('error-box');

	  game.addEventListener(_consts.GOT_APPLE, function (_ref) {
	    var apples = _ref.apples;

	    infoBox.display('Apples: ' + apples);
	    SNAKE_SOUND.play();
	  });

	  game.addEventListener(_consts2.ERROR, function (_ref2) {
	    var errorMsg = _ref2.errorMsg;

	    errorBox.display('Game over! ' + errorMsg);
	  });

	  game.addEventListener(_consts2.START, function () {
	  ...
	  game.addEventListener(_consts2.PAUSE, function () {
	    SOUNDTRACK.pause();
	  });

	  game.addEventListener(_consts2.RESUME, function () {
	    SOUNDTRACK.play();
	  });
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Game2 = __webpack_require__(329);

	var _Game3 = _interopRequireDefault(_Game2);

	var _Vector = __webpack_require__(332);

	var _Vector2 = _interopRequireDefault(_Vector);

	var _Point = __webpack_require__(333);

	var _Point2 = _interopRequireDefault(_Point);

	var _Snake = __webpack_require__(335);

	var _Snake2 = _interopRequireDefault(_Snake);

	var _Apple = __webpack_require__(337);
	...
	var LEFT = new _Vector2.default(-1, 0);
	var RIGHT = new _Vector2.default(1, 0);
	var UP = new _Vector2.default(0, -1);
	var DOWN = new _Vector2.default(0, 1);

	var INIT_SNAKE_SIZE = 10;
	var INIT_SNAKE_VECTOR = DOWN;
	var INIT_SNAKE_POINT = new _Point2.default(0, 0);

	var SPEED_UP_FACTOR = 0.99;
	...
	var SnakeGame = function (_Game) {
	  ...
	  function SnakeGame(canvas) {
	    ...
	    var _this = _possibleConstructorReturn(this, (SnakeGame.__proto__ || Object.getPrototypeOf(SnakeGame)).call(this, canvas, SIZE, INTERVAL_TIME));

	    _this.directionsBuffer = [];

	    _this.changeDirection = function (e) {
	      var newDirection = KEYBOARD_ARROW[e.code];
	      var currentDir = _this.directionsBuffer[_this.directionsBuffer.length - 1] || _this.direction;

	      if (newDirection && !currentDir.add(newDirection).isZero()) {
	        _this.directionsBuffer.push(newDirection);
	      }
	    };

	    _this.render = function () {
	      if (_this.directionsBuffer.length === 0) {
	        _this.directionsBuffer.push(_this.direction);
	      }

	      while (_this.directionsBuffer.length > 0) {
	        _this.direction = _this.directionsBuffer.shift();
	        _this.snake.move(_this.direction);
	      }

	      if (_this.snake.collideWith(_this.apple)) {
	        _this.apples += 1;
	        _this.emit(_consts.GOT_APPLE, { apples: _this.apples });
	        _this.drawApple();
	        _this.snake.grow(_this.direction);
	        _this.speedUp();
	      }

	      _this.draw(_this.snake, 'Snake');
	      _this.draw(_this.apple, 'Apple');
	    };

	    _this.initGame = function () {

	      _this.directionsBuffer = [];
	      _this.snake = new _Snake2.default(INIT_SNAKE_SIZE, INIT_SNAKE_POINT, INIT_SNAKE_VECTOR);
	      _this.direction = INIT_SNAKE_VECTOR;
	      _this.apples = 0;
	      _this.gameIntervalTime = INTERVAL_TIME;
	    ...
	    _this.speedUp = function () {
	      _this.stop();
	      _this.gameIntervalTime *= SPEED_UP_FACTOR;
	      _this.go();
	    };

	    _this.beforeGo = function () {
	      document.addEventListener('keydown', _this.changeDirection);
	    };

	    _this.afterStop = function () {
	      document.removeEventListener('keydown', _this.changeDirection);
	    };
	  ...
	  _createClass(SnakeGame, [{
	    ...
	    value: function drawApple() {
	      this.apple = new _Apple2.default(this.size - 1);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _EventListener2 = __webpack_require__(330);

	var _EventListener3 = _interopRequireDefault(_EventListener2);

	var _consts = __webpack_require__(331);
	...
	var Game = function (_EventListener) {
	  _inherits(Game, _EventListener);

	  function Game(canvas, size, gameIntervalTime) {
	    ...
	    _this.renderCanvas = function () {
	      ...
	      for (var x = 0; x < _this.size; x++) {
	        for (var y = 0; y < _this.size; y++) {
	          canvasBuffer += _this.game[y][x];
	        }
	        canvasBuffer += '\n';
	      }

	      _this.clear();
	      _this.canvas.innerHTML = canvasBuffer;
	    };

	    _this.stop = function () {
	      clearInterval(_this.gameInterval);
	      _this.gameInterval = null;
	      _this.afterStop();
	    };

	    _this.step = function () {
	      try {
	        _this.emit(_consts.STEP, { drawObject: _this.draw });
	        _this.render();
	        _this.renderCanvas();
	      } catch (error) {
	        _this.emit(_consts.ERROR, { errorMsg: error.message });
	        _this.stop();
	      }
	    };
	    ...
	    _this.go = function () {
	      _this.beforeGo();
	      _this.gameInterval = setInterval(_this.step, _this.gameIntervalTime);
	    };

	    _this.pause = function () {
	      if (_this.gameInterval) {
	        _this.stop();
	        _this.emit(_consts.PAUSE);
	      } else {
	        _this.go();
	        _this.emit(_consts.RESUME);
	      }
	    };

	    _this.start = function () {
	      _this.emit(_consts.START);
	      _this.stop();
	      _this.clear();
	      _this.initGame();
	      _this.renderCanvas();
	    ...
	    _this.canvas = canvas;
	    _this.size = size;
	    _this.gameIntervalTime = gameIntervalTime;
	    return _this;
	  }
	  ...
	  _createClass(Game, [{
	    ...
	    key: 'draw',
	    value: function draw(_ref, displayName) {
	      var body = _ref.body;
	    ...
	    key: 'isOutOfBound',
	    value: function isOutOfBound(_ref2) {
	      var x = _ref2.x,
	          y = _ref2.y;
	      var displayName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Object';
...
/***/ (function(module, exports) {
	...
	var EventListener = function EventListener() {
	  ...
	  this.addEventListener = function (name, fn) {
	    ...
	    if (fn) {
	      _this.listeners[name].push(fn);
	    }
	  };

	  this.removeEventListener = function (name, fn) {
	    if (_this.listeners[name]) {
	      _this.listeners[name] = _this.listeners[name].filter(function (lfn) {
	        return lfn !== fn;
	      });
	    }
	  };
	  ...
	  this.emit = function (name, event) {
	    if (_this.listeners[name]) {
	      _this.listeners[name].forEach(function (lfn) {
	        lfn(event);
	      });
	    }
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Point = (_temp = _class = function Point(x, y) {
	  ...
	  this.move = function (vector) {
	    return new Point(_this.x + vector.x, _this.y + vector.y, _this.sign, _this.color);
	  };

	  this.isSame = function (point) {
	    return point.x === _this.x && point.y === _this.y;
	  };
	...
	Point.draw = function () {
	  ...
	  var maxX = arguments[1];
	  var minX = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
	  var maxY = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : maxX;
	  var minY = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : minX;

	  return new Point((0, _utils.getRandomInt)(minX, maxX), (0, _utils.getRandomInt)(minY, maxY), sign);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _GameObject2 = __webpack_require__(336);
	...
	var EATEN_ITSELF_ERROR = 'You have eaten yourself, what a shame!';

	var Snake = function (_GameObject) {
	  _inherits(Snake, _GameObject);

	  function Snake(size, startPoint, startVector) {
	    ...
	    _this.body = [startPoint];

	    var i = 0;
	    while (i < size - 1) {
	      _this.growHead(startVector);
	      i++;
	    }
	    return _this;
	  }
	  ...
	  _createClass(Snake, [{
	    key: 'growHead',
	    value: function growHead(vector) {
	      var head = this.body[this.body.length - 1];
	      head.setSign(BODY);

	      var newHead = head.move(vector);
	      for (var _i = 0; _i < this.body.length; _i++) {
	        if (newHead.isSame(this.body[_i])) {
...
/***/ (function(module, exports) {
	...
	var GameObject = function GameObject() {
	  ...
	  this.collideWith = function (_ref) {
	    var body = _ref.body;

	    var bodyDict = _this.bodyToDict();
	    for (var i = 0; i < body.length; i++) {
	      var pointKey = body[i].toKey();
	  ...
	  this.bodyToDict = function () {
	    return _this.body.reduce(function (dict, point) {
	      dict[point.toKey()] = 1;
	      return dict;
	    }, {});
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Apple = function (_GameObject) {
	  _inherits(Apple, _GameObject);

	  function Apple(gameSize) {
	    _classCallCheck(this, Apple);

	    var _this = _possibleConstructorReturn(this, (Apple.__proto__ || Object.getPrototypeOf(Apple)).call(this));

	    var point = _Point2.default.draw(' ', gameSize);
...
/***/ (function(module, exports) {
	...
	var Box = function Box(id) {
	  var _this = this;

	  _classCallCheck(this, Box);

	  this.display = function (text) {
	    _this.box.innerHTML = text;
	  };
